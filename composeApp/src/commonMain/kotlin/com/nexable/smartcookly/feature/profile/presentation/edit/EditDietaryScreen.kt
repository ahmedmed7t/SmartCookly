...
@Composable
fun EditDietaryScreen(
    onNavigateBack: () -> Unit,
    onSaveComplete: () -> Unit,
    viewModel: EditPreferenceViewModel = koinInject(),
    authRepository: AuthRepository = koinInject()
) {
    val selectedDietaryStyle by viewModel.selectedDietaryStyle.collectAsState()
    val otherDietaryStyleText by viewModel.otherDietaryStyleText.collectAsState()
    val isSaving by viewModel.isSaving.collectAsState()
    val showOtherTextField = selectedDietaryStyle == DietaryStyle.OTHER
